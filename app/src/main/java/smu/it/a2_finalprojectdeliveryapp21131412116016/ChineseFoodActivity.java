...
public class ChineseFoodActivity extends AppCompatActivity {
    ...
    static int count31 = 0, count32 = 0, count33 = 0, count34 = 0, count35 = 0;
    TextView textView_1,textView_2,textView_3,textView_4,textView_5;

    static StringBuilder order_list3 = new StringBuilder();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ChineseFoodActivity.this, MainActivity.class);
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ChineseFoodActivity.this, CartActivity.class);
                startActivity(intent);
                finish();
            }
        });
            ...
            switch (v.getId()) {
                case R.id.button1:
                    if (count31==0) {
                        ...
                        // 메뉴 입력
                        order_list3.append("짜장면 \n");
                        orderProduct.setText(order_list3);
                    } else {
                        count31++;
                        textView_1.setText("x " + count31);
                    }
